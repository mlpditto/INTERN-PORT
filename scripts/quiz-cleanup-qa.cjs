...
(async () => {
    ...
    try {
        ...
        await prepare(); assert.match(await page.locator('#qc-status').innerText(),/at least one/);
        ...
        console.log('PASS: multi-quiz marking, duplicate occurrences, zero-question guard, review, source safety, mixed original/copy atomic commit, backups and uncertain retry');
