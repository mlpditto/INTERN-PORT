(function () {
    ...
    window.openQuizMerge = function(ids) {
        ...
        <section class="qm-step"><h4>1 · 📝 Name your quiz</h4><label for="qm-title">New quiz title</label><input id="qm-title" maxlength="200" value="Merged quiz" title="ตั้งชื่อชุดข้อสอบใหม่"></section>
        ...
        <details class="qm-hint"><summary title="ดูสิ่งที่จะเกิดขึ้นเมื่อรวมชุด">ℹ️ Merge details</summary><p>All questions are retained. Use Compare first to review duplicates. Other settings follow the first source. The new quiz starts inactive.</p></details></section>
