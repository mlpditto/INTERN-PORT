...
### 3. การจัดการแบบทดสอบ (Quiz Setup)
...
- **Scheduling:** ตั้งเวลาเปิด-ปิด (Start Time & Deadline)
- **Per-question Timers:** กำหนดเวลาคิดรายข้อแยกกันได้
- **Reposting:** ปุ่มสำหรับ Reset ข้อมูลเวลาเพื่อนำแบบทดสอบเดิมมาใช้ใหม่สำหรับ Cohort หรือนักศึกษาชุดใหม่
