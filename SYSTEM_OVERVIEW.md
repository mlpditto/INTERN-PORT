# MLP Internship Portfolio (V80.0) Overview
...
- **📚 Read-only Learning Mode (V80.0):** 
    - **Content Consumption:** โหมดสำหรับการเรียนรู้ผ่านการอ่านเนื้อหา (Passage) โดยตรง โดยไม่ต้องมีข้อสอบแบบตัวเลือก
    - **Reflection & Feedback:** ระบบจะแสดงช่องให้ผู้เรียนพิมพ์สรุปสิ่งที่ได้เรียนรู้ (Reflection) หลังอ่านจบ เพื่อส่งให้แอดมินตรวจสอบ
    - **Auto-Grading Logic:** เมื่อผู้เรียนส่ง Feedback ระบบจะให้คะแนนเต็มตามที่กำหนดไว้ทันที (Pending Approval) และเปลี่ยนสถานะการเรียนเป็นเสร็จสมบูรณ์
    - **Admin Review:** แอดมินสามารถอ่าน Feedback ของผู้เรียนได้ในหน้า Review พร้อมระบบแสดงผลที่สวยงามแยกส่วนจากข้อสอบปกติ
