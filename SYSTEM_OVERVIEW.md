# MLP Internship Portfolio (V90.52) Overview

> [!IMPORTANT]
> **📢 กฎการพัฒนา (Development Rule):**
>
> 1. แก้ไขโค้ดที่ `production` เสมอ ห้ามแก้ที่ `main`
> 2. ทุกครั้งที่ Commit ต้องอัปเดตเวอร์ชัน (V90.52) ใน `admin.html` (Title & Badge)
...
- **Global Version Sync:** Synchronized `admin.html`, `index.html`, and `SYSTEM_OVERVIEW.md` to V89.76.
