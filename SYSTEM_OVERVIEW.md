...
- **Smart Features (V77):**
    ...
    *   **✨ Leaderboard & Divisions (V77.8):** ระบบจัดอันดับแยกตามกลุ่ม (Divisions):
        *   **Division Management:** Admin สามารถจัดกลุ่ม (Groups) เข้าเป็น Division (เช่น IT+Marketing = Div 1) เพื่อแยก Leaderboard ได้
        *   **User Leaderboard:** เพิ่มปุ่ม "🏅 ดูอันดับ" ในหน้า User เพื่อให้ดูแรงกิ้งภายใน Division ของตัวเองได้
        *   **Automated Updates:** ระบบคำนวณอันดับแบบ Real-time ตามคะแนนสะสม
