# MLP Internship Portfolio (V77.15) Overview
...
- **Smart Features (V77):**
    ...
    *   **✨ Flexible Visibility & Insight (V77.10):**
        ...
        *   **Participant Tracking (V77.15):** Admin สามารถเรียกดูรายชื่อผู้เข้าสอบในแต่ละ Quiz ได้โดยละเอียดผ่านไอคอน 👥 เพื่อดูคะแนน สถานะ และเวลาที่ส่งงานรายคน พร้อมระบบ **"Reset"** (เพื่อให้ทำใหม่ได้) และตัวเลือก **"Hide Scores"** สำหรับซ่อนคะแนนชั่วคราวเพื่ออำนวยความสะดวกในการจับภาพหน้าจอ (Capture) เผยแพร่รายชื่อผู้ส่งงานโดยไม่เปิดเผยคะแนน
        ...
        *   **Enhanced Group UI (V77.14):** ปรับปรุงการแสดงผลกลุ่ม (Groups) ให้มีสีสันที่แตกต่างกันชัดเจนและเพิ่มไอคอนประจำสายงาน เพื่อช่วยในการแยกแยะและจัดการข้อมูลได้รวดเร็วยิ่งขึ้น ทั้งในหน้า Admin และหน้าโปรไฟล์ของนักศึกษา
...
---
*บันทึกภาพรวมระบบฉบับสมบูรณ์ (V77.15) โดย Antigravity AI*
