...
- **Enhanced UI:** ปรับปรุงหน้าจอจัดการให้เป็นระเบียบและลดความผิดพลาด (V71.4)
    ...
    - **New Question Layout:** ปรับแต่งรูปแบบตัวเลือก (Options) เป็นแบบ ก. ข. ค. ง. เรียง 1 แถวต่อ 1 ข้อความ อ่านง่ายขึ้น
    - **Visual Selection:** เลือกคำตอบที่ถูกผ่านปุ่มวงกลมตัวเลข 1, 2, 3, 4 แทน Dropdown เดิม
