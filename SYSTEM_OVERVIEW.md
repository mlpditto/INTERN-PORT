# MLP Internship Portfolio (V77.12) Overview
...
- **Smart Features (V77):**
    ...
    *   **✨ Flexible Visibility & Insight (V77.10):**
        ...
        *   **Visibility Control:** Admin สามารถตั้งค่าการมองเห็นเมนู (Status, Kanban, Assignments) แยกตามกลุ่มนักศึกษาได้ ทำให้แอป LIFF ปรับเปลี่ยนหน้าตาตามความเหมาะสมของแต่ละสายงาน
...
---
*บันทึกภาพรวมระบบฉบับสมบูรณ์ (V77.12) โดย Antigravity AI*
